<div class="flex flex-col col-span-full sm:col-span-6 bg-white shadow-md rounded-sm border border-slate-200">
    <header class="px-5 py-4 border-b border-slate-100 flex items-center">
        ...
        <div class="relative ml-2" x-data="{ open: false }" @mouseenter="open = true" @mouseleave="open = false">
            ...
            <div class="z-10 absolute bottom-full left-1/2 -translate-x-1/2">
                <div class="bg-white border border-slate-200 p-3 rounded shadow-lg overflow-hidden mb-2" x-show="open"
